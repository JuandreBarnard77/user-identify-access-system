    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Red Team Developers" },
                    { 2, "Admins" },
                    { 3, "Blue Team Developers" },
                    { 4, "Viewers" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "bobsteve@example.org", "Bob", "Steve" },
                    { 2, "sandysteven@example.org", "Sandy", "Stevin" },
                    { 3, "johnyrobers@example.org", "Johny", "Robers" }
                });
